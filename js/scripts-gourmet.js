...
//		});
			...
			// Click handlers for la-list

    	$('.la-list .la-item-img-wrapper, .la-list .la-item-content ').on('click', function(e) {
    		$(this).closest('.la-item').find('.link-read-more').trigger('click');
    	});
